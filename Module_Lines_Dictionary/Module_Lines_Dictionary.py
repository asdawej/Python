...
while True:
    choice_1=eg.choicebox(msg='Please choose a operation:', title=TITLE, choices=CHOICES_1)
    with open('ModuleNames.txt', mode='r', encoding='utf-8') as ModuleNames:
        list_ModuleNames=ModuleNames.readlines()
    def search():
        choice_2=eg.choicebox(msg='Please choose a module:', title=TITLE, choices=list_ModuleNames)
    ...
    def add():
        choice_2_add=eg.choicebox(msg='Is a module or a line?:', title=TITLE, choices=CHOICES_2_ADD)
        def add_module():
